    ...
    <div className="flex flex-col gap-6 max-w-2xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure your project&apos;s public profile and access credentials.</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-muted-foreground">System URL</label>
