...
import useConnectionLoader from "@/hooks/use-connection-loader";
...
export default function ConnectionLoadingScreen({
  isConnecting,
  isConnected,
  error,
  connectionSeq,
  ...
  const { isVisible, isFadingOut, isOfflineAlertOpen, handleDismissOffline } =
    useConnectionLoader(isConnecting, isConnected, error, connectionSeq);
